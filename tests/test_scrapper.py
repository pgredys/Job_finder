...
def job_data(soup):
    ...
    job_name_data = []
    for item in soup.find_all("h2", class_="jobTitle css-14z7akl eu4oa1w0"):
...
def company_data(soup):
    ...
    # and convert into string
    company_data = []
    for item in soup.find_all("span", class_="css-92r8pb eu4oa1w0"):
        company_data.append(item.get_text())

    address_data = []
    for item in soup.find_all("div", class_="css-1p0sjhy eu4oa1w0"):
